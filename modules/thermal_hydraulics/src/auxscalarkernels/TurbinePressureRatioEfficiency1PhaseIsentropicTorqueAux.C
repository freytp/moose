...
registerMooseObject("ThermalHydraulicsApp", TurbinePressureRatioEfficiency1PhaseIsentropicTorqueAux);
...
TurbinePressureRatioEfficiency1PhaseIsentropicTorqueAux::TurbinePressureRatioEfficiency1PhaseIsentropicTorqueAux(
