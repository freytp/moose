...
registerMooseObject("ThermalHydraulicsApp", TurbinePressureRatioEfficiency1PhaseDissipationTorqueAux);
...
TurbinePressureRatioEfficiency1PhaseDissipationTorqueAux::TurbinePressureRatioEfficiency1PhaseDissipationTorqueAux(
