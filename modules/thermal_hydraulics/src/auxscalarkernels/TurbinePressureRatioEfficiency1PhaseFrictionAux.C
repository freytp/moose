...
TurbinePressureRatioEfficiency1PhaseFrictionAux::validParams()
{
  ...
  params.addClassDescription("Friction torque computed in the 1-phase pressure ratio efficiency turbine.");
  return params;
}

TurbinePressureRatioEfficiency1PhaseFrictionAux::TurbinePressureRatioEfficiency1PhaseFrictionAux(const InputParameters & parameters)
