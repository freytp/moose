...
[ControlLogic]
  ...
  [logic]
    ...
    function = 'if(t < 5, a, if(t <= ${t1}, b, c))'
    vars = 'a b c'
    vals = 'motor_torque_fn_start initial_motor_PID:output motor_torque_fn_shutdown'
  []
[]
